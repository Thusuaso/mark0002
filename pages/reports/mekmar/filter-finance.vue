<template>
  <div>
    <div class="row">
      <div class="col-9">
        <h3>
          FOB, CFR, DAP, DDP ve CIF yüklemelerinin evrak masrafı olması
          gerekiyor.(İstinai durumlarda el ile silinmesi gerekiyor.)
        </h3>
      </div>
      <div class="col-3">
