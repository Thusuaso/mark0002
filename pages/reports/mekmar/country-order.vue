...
<script>
    ...
    export default {
        ...
        created(){
            this.$axios.get('/reports/ayo/country/order/list')
            .then(res=>{
                this.list_this_year = res.data.list.filter(x=>x.Year === 2024);
                this.list_one_year_ago = res.data.list.filter(x=>x.Year === 2023);
                this.list_two_year_ago = res.data.list.filter(x=>x.Year === 2022);
                this.list_three_year_ago = res.data.list.filter(x=>x.Year === 2021);
                this.list_four_year_ago = res.data.list.filter(x=>x.Year === 2020);
                this.list_five_year_ago = res.data.list.filter(x=>x.Year === 2019);
        ...
        methods:{
            excel_output(){
                ...
                api
                .post("/maliyet/dosyalar/countries", data)
                .then((response) => {
                if (response.status) {
