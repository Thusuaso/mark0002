<template>
    <div class="container">
        ...
        <Dialog :visible.sync="bgp_new_dialog" modal header="Yeni Bgp" :contentStyle="{overflow: 'visible'}">
            <bgpNewForm :countryList="getCountryList" @closed_bgp_dialog="bgp_new_dialog = false" />
        </Dialog>
        ...
        <Dialog :visible.sync="bgp_detail_form_dialog_vis" modal>
            <bgpDetailForm :formData="bgpDetailFormData" :projectName="bgp_project_name" @bgp_detail_form_dialog_closed="bgp_detail_form_dialog_vis = false"/>
        </Dialog>
    </div>
</template>
<script>
