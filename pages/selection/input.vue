<template>
    <div class="">
        <selection :productionTotal="getProductionTotal" @products_status_selected="productsStatusSelected($event)" @selection_production_dialog="selection_production_dialog_form=true"/>
        <selectionList :products="getProductList" :total="getProductionSumTotal" @product_selected_emit="productSelectedEmit($event)" :loading="getLoading"/>
        <Dialog :visible.sync="selection_production_dialog_form" header="" modal>
            <selectionForm @selection_production_dialog_form="selection_production_dialog_form = $event" :suppliers="getSupplierList" :orders="getOrdersList" :products="getProductionProductsList" :mines="getMineList" :model="model" :buttonStatus="getProductionButtonStatus"/>
        </Dialog>
    </div>
</template>
<script>
