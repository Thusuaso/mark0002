...
const actions = {
    setMekmarList(vuexContext) {
        ...
        this.$axios.get('/customer/mekmar/list')
        .then(response=>{
    ...
    setMekmarCustomerUpdate(vuexContext,payload){
        this.$axios.put('/customer/mekmar/update',payload)
        .then(response=>{
            if(response.data.status){
    ...
    setOfferCustomerList(vuexContext) {
        vuexContext.dispatch('setBeginLoadingAction');
        this.$axios.get('/customer/offer/list')
        .then(response=>{
    ...
    setOfferCustomerSave(vuexContext,payload){
        this.$axios.post('/customer/offer/save',payload)
        .then(response=>{
            if(response.data.status){
    ...
    setOfferCustomerDelete(vuexContext,id){
        this.$axios.delete(`/customer/offer/delete/${id}`)
        .then(response=>{
            if(response.data.status){
                vuexContext.dispatch('setOfferCustomerList');
                this.$toast.success('Başarıyla Silindi.');
    ...
    setOfferCustomerUpdate(vuexContext,payload){
        this.$axios.put('/customer/offer/update',payload)
        .then(response=>{
            if(response.data.status){
                vuexContext.dispatch('setOfferCustomerList');
                this.$toast.success('Başarıyla Güncellendi.');
    ...
    setBgpCustomerList(vuexContext) {
        vuexContext.dispatch('setBeginLoadingAction');
        this.$axios.get('/customer/bgp/list')
        .then(response=>{
    ...
    setBgpCustomerDelete(vuexContext,id){
        this.$axios.delete(`/customer/bgp/delete/${id}`)
        .then(response=>{
            if(response.data.status){
    ...
    setBgpCustomerSave(vuexContext,payload){
        this.$axios.post(`/customer/bgp/save`,payload)
        .then(response=>{
            if(response.data.status){
                vuexContext.dispatch('setBgpCustomerList');
                this.$toast.success('Başarıyla Kaydedildi.');
    ...
    setBgpCustomerUpdate(vuexContext,payload){
        this.$axios.put('/customer/bgp/update',payload)
        .then(response=>{
            if(response.data.status){
                vuexContext.dispatch('setBgpCustomerList');
                this.$toast.success('Başarıyla Güncellendi.');
    ...
    setFairCustomerList(vuexContext) {
        vuexContext.dispatch('setBeginLoadingAction');
        this.$axios.get('/customer/fair/list')
        .then(response=>{
    ...
    setFairCustomerSave(vuexContext, payload) {
        this.$axios.post('/customer/fair/save', payload)
            .then(response => {
                if (response.data.status) {
    ...
    setFairCustomerDelete(vuexContext, id) {
        this.$axios.delete(`/customer/fair/delete/${id}`)
            .then(response => {
                if (response.data.status) {
    ...
    setFairCustomerUpdate(vuexContext, payload) {
        this.$axios.put('/customer/fair/update', payload)
            .then(response => {
                if (response.data.status) {
                    vuexContext.dispatch('setFairCustomerList');
                    this.$toast.success('Başarıyla Güncellendi.');
    ...
    setSelectionCustomerList(vuexContext, userId) {
        vuexContext.dispatch('setBeginLoadingAction');
        this.$axios.get(`/customer/selection/list/${userId}`)
            .then(response => {
