...
const actions = {
  ...
  setMekmarGuSellerOrderDetail(vuexContext, payload) {
    return new Promise((resolve, reject) => {
      this.$axios
        .get(
          `/reports/gu/mekmar/order/seller/${payload.month}/${payload.year}/${payload.userId}`
        )
        .then((response) => {
          if (response) {
            vuexContext.commit(
              "setMekmarGuSellerOrderDetail",
  ...
  setMekmarGuOperationOrderDetail(vuexContext, payload) {
    return new Promise((resolve, reject) => {
      this.$axios
        .get(
          `/reports/gu/mekmar/order/operation/${payload.month}/${payload.year}/${payload.userId}`
        )
        .then((response) => {
          if (response) {
            vuexContext.commit(
  ...
  setMekmarGuSellerForwardingDetail(vuexContext, payload) {
    return new Promise((resolve, reject) => {
      this.$axios
        .get(
          `/reports/gu/mekmar/forwarding/seller/${payload.month}/${payload.year}/${payload.userId}`
        )
        .then((response) => {
          if (response) {
            vuexContext.commit(
  ...
  setMekmarGuOperationForwardingDetail(vuexContext, payload) {
    return new Promise((resolve, reject) => {
      this.$axios
        .get(
          `/reports/gu/mekmar/forwarding/operation/${payload.month}/${payload.year}/${payload.userId}`
        )
        .then((response) => {
          if (response) {
            vuexContext.commit(
  ...
  setMekmarGuOrdererOperationList(vuexContext, userId) {
    return new Promise((resolve, reject) => {
      this.$axios
        .get("/reports/mekmar/gu/operation/orderer/list/" + userId)
        .then((response) => {
          if (response) {
            vuexContext.commit(
  ...
  setReportsMekmarSummaryOrderListByRepresentative(vuexContext, userId) {
    this.$axios
      .get(`/reports/mekmar/summary/order/list/by/representative/${userId}`)
      .then((response) => {
        vuexContext.commit(
        ...
        vuexContext.dispatch(
          "setReportsMekmarSummaryOrderListByRepresentativeTotal",
          response.data.items
        );
      });
  },
  setReportsMekmarSummaryOrderDetailRepresentative(vuexContext, payload) {
    this.$axios
      .get(
        `/reports/mekmar/summary/order/list/by/representative/detail/${payload.userId}/${payload.month}/${payload.year}`
      )
      .then((response) => {
        vuexContext.commit(
          "setReportsMekmarSummaryOrderDetail",
          response.data.list
        );
        vuexContext.dispatch(
          "setReportsMekmarSummaryOrderDetailTotal",
          response.data.list
        );
  ...
  setProductionFilterList(vuexContext, filter) {
    ...
    this.$axios
      .post("/reports/mekmer/production/filter", filter)
      .then((response) => {
        vuexContext.commit(
  ...
  setReportsMekmerStockList(vuexContext) {
    vuexContext.dispatch("setBeginLoadingAction");
    this.$axios.get("/reports/mekmer/stock/list").then((response) => {
  ...
  setReportsMekmerStockListStock(vuexContext) {
    vuexContext.dispatch("setBeginLoadingAction");
    this.$axios.get("/reports/mekmer/stock/list/stock").then((response) => {
      vuexContext.commit("setReportsMekmerStockList", response.data.list);
      vuexContext.commit("setReportsMekmerStockListTotal", response.data.list);
      vuexContext.dispatch("setEndLoadingAction");
    });
  ...
  setReportsMekmerStockListMekmer(vuexContext) {
    vuexContext.dispatch("setBeginLoadingAction");
    this.$axios.get("/reports/mekmer/stock/list/mekmer").then((response) => {
      vuexContext.commit("setReportsMekmerStockList", response.data.list);
      vuexContext.commit("setReportsMekmerStockListTotal", response.data.list);
      vuexContext.dispatch("setEndLoadingAction");
    });
  ...
  setReportsMekmerStockListMekmerIn(vuexContext) {
    vuexContext.dispatch("setBeginLoadingAction");
    this.$axios.get("/reports/mekmer/stock/list/mekmer/in").then((response) => {
      vuexContext.commit("setReportsMekmerStockList", response.data.list);
      vuexContext.commit("setReportsMekmerStockListTotal", response.data.list);
      vuexContext.dispatch("setEndLoadingAction");
    });
  ...
  setReportsMekmerStockListMekmoz(vuexContext) {
    vuexContext.dispatch("setBeginLoadingAction");
    this.$axios.get("/reports/mekmer/stock/list/mekmoz").then((response) => {
      vuexContext.commit("setReportsMekmerStockList", response.data.list);
      vuexContext.commit("setReportsMekmerStockListTotal", response.data.list);
      vuexContext.dispatch("setEndLoadingAction");
    });
  ...
  setReportsMekmerStockListOuter(vuexContext) {
    vuexContext.dispatch("setBeginLoadingAction");
    this.$axios.get("/reports/mekmer/stock/list/outer").then((response) => {
      vuexContext.commit("setReportsMekmerStockList", response.data.list);
      vuexContext.commit("setReportsMekmerStockListTotal", response.data.list);
      vuexContext.dispatch("setEndLoadingAction");
    });
  ...
  setReportsMekmerStockListOnlyStocksMekmer(vuexContext) {
    vuexContext.dispatch("setBeginLoadingAction");
    this.$axios
      .get("/reports/mekmer/stock/list/only/mekmer")
      .then((response) => {
        vuexContext.commit("setReportsMekmerStockList", response.data.list);
        vuexContext.commit(
          "setReportsMekmerStockListTotal",
          response.data.list
        );
        vuexContext.dispatch("setEndLoadingAction");
      });
  ...
  setReportsAllStockListDetail(vuexContext, payload) {
    vuexContext.dispatch("setBeginLoadingAction");
    this.$axios.post("/reports/all/stock/detail", payload).then((response) => {
  ...
  setReportsStockStockListDetail(vuexContext, payload) {
    vuexContext.dispatch("setBeginLoadingAction");
    this.$axios
      .post("/reports/stock/stock/detail", payload)
      .then((response) => {
        vuexContext.commit("setReportsStockListDetail", response.data.list);
        vuexContext.commit(
          "setReportsStockListDetailTotal",
          response.data.list
        );
        vuexContext.dispatch("setEndLoadingAction");
      });
  ...
  setReportsOuterStockListDetail(vuexContext, payload) {
    vuexContext.dispatch("setBeginLoadingAction");
    this.$axios
      .post("/reports/outer/stock/detail", payload)
      .then((response) => {
        vuexContext.commit("setReportsStockListDetail", response.data.list);
        vuexContext.commit(
          "setReportsStockListDetailTotal",
  ...
  setReportsMekmerStockListDetail(vuexContext, payload) {
    vuexContext.dispatch("setBeginLoadingAction");
    this.$axios
      .post("/reports/mekmer/stock/detail", payload)
      .then((response) => {
        vuexContext.commit("setReportsStockListDetail", response.data.list);
        vuexContext.commit(
          "setReportsStockListDetailTotal",
  ...
  setReportsMekmerInStockListDetail(vuexContext, payload) {
    vuexContext.dispatch("setBeginLoadingAction");
    this.$axios
      .post("/reports/mekmer/stock/detail/in", payload)
      .then((response) => {
        vuexContext.commit("setReportsStockListDetail", response.data.list);
        vuexContext.commit(
          "setReportsStockListDetailTotal",
  ...
  setReportsMekmozStockListDetail(vuexContext, payload) {
    vuexContext.dispatch("setBeginLoadingAction");
    this.$axios
      .post("/reports/mekmoz/stock/detail", payload)
      .then((response) => {
        vuexContext.commit("setReportsStockListDetail", response.data.list);
        vuexContext.commit(
          "setReportsStockListDetailTotal",
  ...
  setReportsMekmozStockListOnlyStocksMekmerDetail(vuexContext, payload) {
    vuexContext.dispatch("setBeginLoadingAction");
    this.$axios
      .post("/reports/mekmer/stock/only/stock/mekmer/detail", payload)
      .then((response) => {
        vuexContext.commit("setReportsStockListDetail", response.data.list);
        vuexContext.commit(
          "setReportsStockListDetailTotal",
  ...
  setReportsMekmerMineList(vuexContext) {
    this.$axios.get("/reports/mekmer/mine/list").then((response) => {
  ...
  setReportsMekmarAyoList(vuexContext, payload) {
    vuexContext.dispatch("setBeginLoadingAction");
    this.$axios
      .get(`/reports/mekmar/ayo/list/${payload.year}/${payload.month}`)
      .then((response) => {
        vuexContext.commit("setReportsMekmarAyoList", response.data.list);
        vuexContext.dispatch(
          "setReportsMekmarAyoListTotal",
          response.data.list
        );
        vuexContext.dispatch("setEndLoadingAction");
      });
  ...
  setReportsMekmarAyoListYear(vuexContext, year) {
    vuexContext.dispatch("setBeginLoadingAction");
    this.$axios
      .get(`/reports/mekmar/ayo/by/year/list/${year}`)
      .then((response) => {
        vuexContext.commit("setReportsMekmarAyoList", response.data.list);
        vuexContext.dispatch(
          "setReportsMekmarAyoListTotal",
  ...
  setLoadingListNotYear(vuexContext) {
    ...
    this.$axios.get("/reports/loading/not/year/list").then((res) => {
  ...
  setLoadingList(vuexContext, date) {
    ...
    this.$axios
      .get(`/reports/loading/list/${date.year}/${date.month}`)
      .then((response) => {
        vuexContext.commit("setLoadingList", response.data);
        vuexContext.commit(
          "setReportsMekmarLoadingListTotal",
          response.data.list
        );
        vuexContext.commit(
          "setReportsMekmarLoadingListYear",
  ...
  setLoadingByCustomerList(vuexContext, date) {
    ...
    this.$axios
      .get(`/reports/loading/list/by/customer/${date.year}/${date.month}`)
      .then((response) => {
        const data = [];
  ...
  setYearlyMonthList(vuexContext, year) {
    return new Promise((resolve, reject) => {
      this.$axios.get(`/reports/loading/list/${year}`).then((response) => {
        if (response) {
  ...
  setReportsMekmarForwardingList(vuexContext) {
    vuexContext.dispatch("setBeginLoadingAction");
    this.$axios.get("/reports/mekmar/forwarding/list").then((response) => {
  ...
  setForwardingFilterList(vuexContext, filter) {
    vuexContext.dispatch("setBeginLoadingAction");
    this.$axios
      .post("/reports/mekmar/forwarding/filter", filter)
      .then((response) => {
        vuexContext.commit(
          "setReportsMekmarForwardingList",
          response.data.list
        );
        vuexContext.dispatch(
          "setReportsMekmarForwardingListTotal",
  ...
  setReportsMekmarForwardingDate(vuexContext, payload) {
    vuexContext.dispatch("setBeginLoadingAction");
    this.$axios
      .post(`/reports/mekmar/forwarding/date`, payload)
      .then((response) => {
        vuexContext.commit(
          "setReportsMekmarForwardingList",
          response.data.list
  ...
  setReportsMekmarSummaryOrderList(vuexContext) {
    vuexContext.dispatch("setBeginLoadingAction");
    this.$axios.get("/reports/mekmar/summary/order/list").then((response) => {
      vuexContext.commit(
        "setReportsMekmarSummaryOrderList",
        response.data.items
      );
      vuexContext.dispatch(
        "setReportsMekmarSummaryOrderListTotal",
        response.data.items
      );
      vuexContext.dispatch("setEndLoadingAction");
    });
  ...
  setReportsMekmarSummaryForwardingList(vuexContext) {
    this.$axios
      .get("/reports/mekmar/summary/forwarding/list")
      .then((response) => {
        vuexContext.commit(
          "setReportsMekmarSummaryForwardingList",
          response.data.items
        );
        vuexContext.commit(
          "setReportsMekmarSummaryForwardingListTotal",
          response.data.items
        );
      });
  },
  ...
  setReportsMekmarSummaryOrderDetail(vuexContext, payload) {
    vuexContext.dispatch("setBeginLoadingAction");
    this.$axios
      .post("/reports/mekmar/summary/order/detail/list", payload)
      .then((response) => {
        vuexContext.commit(
          "setReportsMekmarSummaryOrderDetail",
          response.data.list
  ...
  setReportsMekmarSummaryForwardingDetail(vuexContext, payload) {
    vuexContext.dispatch("setBeginLoadingAction");
    this.$axios
      .post("/reports/mekmar/summary/forwarding/detail/list", payload)
      .then((response) => {
        vuexContext.commit(
          "setReportsMekmarSummaryOrderDetail",
          response.data.list
  ...
  setReportsMekmarGuList(vuexContext) {
    vuexContext.dispatch("setBeginLoadingAction");
    this.$axios.get("/reports/mekmar/gu/list").then((response) => {
      vuexContext.commit("setReportsMekmarGuList", response.data);
      vuexContext.dispatch("setEndLoadingAction");
    });
  },
  setReportsMekmarGuListYear(vuexContext, payload) {
    this.$axios.get(`/reports/mekmar/gu/list/${payload}`).then((response) => {
      vuexContext.commit("setReportsMekmarGuList", response.data);
    });
  },
  setReportsMekmerAtlantaList(vuexContext) {
    vuexContext.dispatch("setBeginLoadingAction");
    this.$axios.get("/reports/mekmer/atlanta/list").then((response) => {
...
const mutations = {
  ...
  setMekmarGuOrdererOperationList(state, payload) {
    ...
    state.reportsMekmarGuOrdererPreviousYearForw =
      payload.previousYearForwarding;
    ...
    state.reportsMekmarGuOperationThisYearForw =
      payload.thisYearOperationForwarding;
    ...
    state.reportsMekmarGuOperationPreviousYearForw =
      payload.previousYearOperationForwarding;
    ...
    state.reportsMekmarGuOperationTwoYearAgoForw =
      payload.twoYearAgoOperationForwarding;
  ...
  setReportsMekmarAyoListTotal(state, payload) {
    ...
    payload.forEach((x) => {
      ...
      state.reportsMekmarAyoListTotal.detailBuyes1 += x.detay_1 + x.detay_2;
      ...
      state.reportsMekmarAyoListTotal.bankCost +=
        x.banka_masrafi + x.kurye_masrafi;
  ...
  setReportsMekmarSummaryForwardingListTotal(state, payload) {
    for (const item of payload) {
      ...
      state.reportsMekmarSummaryForwardingListTotal.push({
        fob: fob,
        ddp: ddp,
      });
    }
  ...
  setReportsMekmarGuList(state, payload) {
    ...
    for (const x of Array(11).keys()) {
      state.reportsMekmarGuForwList.push({
        year: date,
        data: [],
        fob: 0,
        ddp: 0,
      });
      state.reportsMekmarGuOrderList.push({
        year: date,
        data: [],
        fob: 0,
        ddp: 0,
  ...
  setReportsMekmarSummaryOrderListByRepresentativeTotal(state, payload) {
    for (const item of payload) {
      ...
      state.reportsMekmarSummaryOrderListByRepresentativeTotal.push({
        fob: fob,
        ddp: ddp,
      });
    }
