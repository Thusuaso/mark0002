...
const state = {
  ...
  orderProductionSourceTypes: [],
};
const actions = {
  setDivide(vuexContext, payload) {
    return new Promise(async (resolve, reject) => {
      await this.$axios.post("/order/divide", payload).then((response) => {
  ...
  setOrdersProductsDivideList(vuexContext, po) {
    return new Promise(async (resolve, reject) => {
      await this.$axios
        .get("/orders/product/divide/list/" + po)
        .then((response) => {
          if (response) {
            vuexContext.commit(
              "setOrdersProductsDivideList",
              response.data.list
            );
            resolve(true);
          } else {
  ...
  setOrderOnHoldMekmerList(vuexContext) {
    this.$axios.get("/order/onhold/mekmer/list").then((response) => {
  ...
  setOrderProductionMekmerList(vuexContext) {
    return new Promise(async (resolve, reject) => {
      this.$axios.get("/order/production/mekmer/list").then((response) => {
        if (response.data.list) {
          vuexContext.commit("setOrderList", response.data.list);
          vuexContext.commit(
            "setOrderProductionYearsList",
            response.data.years
          );
          vuexContext.commit("setOrderListAll", response.data.list);
          vuexContext.commit("setOrderProductionTotal", response.data.list);
  ...
  setOrderProductionIsfDelete(vuexContext, event) {
    this.$axios
      .get(
        `/production/isf/delete/${event.ID}/${event.EvrakAdi}/${event.SiparisNo}`
      )
      .then((response) => {
        if (response.data.status) {
  ...
  setOrderProductionProformaDelete(vuexContext, id) {
    this.$axios.get(`/production/proforma/delete/${id}`).then((response) => {
      if (response.data.status) {
  ...
  setOrderProductionMekmer2List(vuexContext) {
    this.$axios.get("/order/production/mekmer2/list").then((response) => {
      if (response.data.list) {
        vuexContext.commit("setOrderList", response.data.list);
        vuexContext.commit("setOrderProductionYearsList", response.data.years);
        vuexContext.commit("setOrderListAll", response.data.list);
  ...
  setOrderProductionList(vuexContext) {
    this.$axios.get("/order/production/list").then(async (response) => {
      if (response.data.list) {
  ...
  setOrderProductionListYear(vuexContext, year) {
    this.$axios.get(`/order/production/list/year/${year}`).then((response) => {
      if (response.data.list) {
        vuexContext.commit("setOrderList", response.data.list);
        vuexContext.commit("setOrderProductionTotal", response.data.list);
      }
  ...
  setOrderShippedList(vuexContext) {
    ...
    this.$axios.get("/order/shipped/list").then((response) => {
      if (response.data.list) {
        vuexContext.commit("setOrderList", response.data.list);
        vuexContext.commit("setOrderProductionYearsList", response.data.years);
        vuexContext.commit("setOrderProductionTotal", response.data.list);
  ...
  setOrderShippedMekmerList(vuexContext) {
    vuexContext.dispatch("setBeginLoadingAction");
    this.$axios.get("/order/shipped/mekmer/list").then((response) => {
      if (response.data.list) {
        vuexContext.commit("setOrderList", response.data.list);
        vuexContext.commit("setOrderProductionYearsList", response.data.years);
        vuexContext.commit("setOrderProductionTotal", response.data.list);
  ...
  filterShipment(vuexContext, filter) {
    ...
    this.$axios.post(`/order/shipped/list/filter`, filter).then((response) => {
      if (response.data.list) {
        vuexContext.commit("setOrderList", response.data.list);
        vuexContext.commit("setOrderProductionTotal", response.data.list);
  ...
  setFilterShipmentGlobal(vuexContext, filter) {
    ...
    this.$axios
      .get(`/order/shipped/list/filter/global/${filter}`)
      .then((response) => {
        if (response.data.list) {
          vuexContext.commit("setOrderList", response.data.list);
          vuexContext.commit("setOrderProductionTotal", response.data.list);
  ...
  setOrderShippedListYear(vuexContext, year) {
    vuexContext.dispatch("setBeginLoadingAction");
    this.$axios.get(`/order/shipped/list/year/${year}`).then((response) => {
      if (response.data.list) {
        vuexContext.commit("setOrderList", response.data.list);
        vuexContext.commit("setOrderProductionTotal", response.data.list);
  ...
  setOrderWaitingList(vuexContext) {
    ...
    this.$axios.get("/order/waiting/list").then((response) => {
      if (response.data.list) {
        vuexContext.commit("setOrderList", response.data.list);
        vuexContext.commit("setOrderProductionYearsList", response.data.years);
        vuexContext.commit("setOrderProductionTotal", response.data.list);
  ...
  setOrderWaitingListYear(vuexContext, year) {
    vuexContext.dispatch("setBeginLoadingAction");
    this.$axios.get(`/order/waiting/list/year/${year}`).then((response) => {
      if (response.data.list) {
        vuexContext.commit("setOrderList", response.data.list);
        vuexContext.commit("setOrderProductionTotal", response.data.list);
  ...
  setOrderProductionProductDetailList(vuexContext, po) {
    this.$axios
      .get(`/order/production/product/detail/list/${po}`)
      .then((response) => {
        vuexContext.commit(
        ...
        vuexContext.commit(
          "setOrderProductionProductTotal",
          response.data.list
        );
        vuexContext.dispatch(
          "setOrderProductionProductDetailTotal",
          response.data.list
        );
      });
  },
  setOrderProductionProductDetailMekmerList(vuexContext, po) {
    this.$axios
      .get(`/order/production/product/detail/mekmer/list/${po}`)
      .then((response) => {
        vuexContext.commit(
          "setOrderProductionProductDetailList",
          response.data.list
    ...
    this.$axios
      ...
      .then((response) => {
        if (response.data.status) {
          ...
          vuexContext.commit("setOrderProductAdded", {
            ...payload,
            ID: response.data.id,
          });
          vuexContext.dispatch(
            "setOrderProductionCheckList",
            payload.SiparisNo
          );
          vuexContext.dispatch(
            "setOrderProductionSupplierList",
            payload.SiparisNo
          );
  ...
  setOrderProductUpdated(vuexContext, payload) {
    this.$axios
      .put("/order/production/product/update", payload)
      .then((response) => {
        if (response.data.status) {
  ...
  setOrderProductDeleted(vuexContext, payload) {
    this.$axios
      .delete(`/order/production/product/delete/${payload.ID}`)
      .then((response) => {
        if (response.data.status) {
  ...
  setOrderProformaUpload(vuexContext, payload) {
    this.$axios
      .post("/order/production/proforma/upload", payload)
      .then((response) => {
        if (response.data.status) {
  ...
  setOrderProductionCostList(vuexContext, po) {
    this.$axios.get(`/order/production/cost/list/${po}`).then((response) => {
  ...
  setOrderProductionSupplierList(vuexContext, po) {
    this.$axios
      .get(`/order/production/product/supplier/${po}`)
      .then((response) => {
        vuexContext.commit(
          "setOrderProductionSupplierList",
          response.data.list
  ...
  setOrderSupplierProductList(vuexContext, payload) {
    this.$axios
      .get(
        `/order/production/supplier/product/${payload.po}/${payload.supplier}`
      )
      .then((response) => {
  ...
  setProductionProductSupplierIsfSave(vuexContext, payload) {
    return new Promise((resolve, reject) => {
      this.$axios
        .post("/order/production/supplier/isf/save", payload)
        .then((response) => {
          if (response.data.status) {
  ...
  setOrderProductionDocumentList(vuexContext, po) {
    this.$axios
      .get(`/order/production/product/document/${po}`)
      .then((response) => {
        vuexContext.commit(
          "setOrderProductionDocumentList",
          response.data.list
        );
      });
  },
  setOrderProductionCheckList(vuexContext, po) {
    this.$axios
      .get(`/order/production/product/check/${po}`)
      .then((response) => {
        vuexContext.commit("setOrderProductionCheckList", response.data.list);
        vuexContext.dispatch(
          "setOrderProductionCheckListTotal",
          response.data.list
        );
      });
  },
  setOrderProductionCheckMekmerList(vuexContext, po) {
    this.$axios
      .get(`/order/production/product/check/mekmer/${po}`)
      .then((response) => {
        vuexContext.commit("setOrderProductionCheckList", response.data.list);
        vuexContext.dispatch(
          "setOrderProductionCheckListTotal",
  ...
  setOrderProductionSave(vuexContext, production) {
    this.$axios.post("/order/production/save", production).then((response) => {
      if (response.data.status) {
        this.$toast.success(
          "Başarıyla Kaydedildi. Ürünlerinizi Girebilirsiniz!"
        );
  ...
  setOrderProductionUpdate(vuexContext, production) {
    this.$axios.put("/order/production/update", production).then((response) => {
      if (response.data.status) {
        this.$toast.success("Başarıyla Güncellendi.");
      } else {
        this.$toast.error("Güncelleme Başarısız");
  ...
  setProductionProductWorkermanList(vuexContext, workerman) {
    this.$axios
      .get(
        `/order/production/product/workerman/${workerman.po}/${workerman.productId}`
      )
      .then((response) => {
        vuexContext.commit(
          "setProductionProductWorkermanList",
          response.data.list
        );
        vuexContext.commit(
          "setProductionProductWorkermanCalculation",
          response.data.workerman
        );
      });
  },
  setProductionProductWorkermanSave(vuexContext, workerman) {
    this.$axios
      .post("/order/production/product/workerman/save", workerman)
      .then((response) => {
        if (response.data.status) {
          const data = {
  ...
  setProductionProductWorkermanDelete(vuexContext, workerman) {
    this.$axios
      .delete(`/order/production/product/workerman/delete/${workerman.ID}`)
      .then((response) => {
        if (response.data.status) {
          const data = {
            productId: workerman.UrunKartId,
  ...
  setProductionProductWorkermanUpdate(vuexContext, workerman) {
    this.$axios
      .put("/order/production/product/workerman/update", workerman)
      .then((response) => {
        if (response.data.status) {
          const data = {
            productId: workerman.UrunKartId,
  ...
  setProductionProductSaveMail(vuexContext, production) {
    this.$axios
      .post("/order/production/product/save/mail", production)
      .then((response) => {
        if (response.data.status) {
  ...
  setOrderProductionIsfSendMail(vuexContext, payload) {
    this.$axios.post("/production/isf/send/mail", payload).then((response) => {
      if (response.data.status) {
        this.$toast.success("Mail Gönderildi.");
      }
    });
  },
  setOrderProductionSourceTypes(vuexContext, payload) {
    this.$axios.get("/order/production/source/types").then((response) => {
      vuexContext.commit("setOrderProductionSourceTypes", response.data.list);
    });
  },
};
const mutations = {
  ...
  setProductionDivideOrderListUpdate(state, payload) {
    if (state.orderProductionDivideOrderList.length > 0) {
      const index = state.orderProductionDivideOrderList.findIndex(
        (x) => x.id == payload.id
      );
  ...
  setOrderProductionProformaDelete(state, id) {
    const index = state.orderProductionDocumentList.findIndex(
      (x) => x.ID == id
    );
  ...
  setOrderProductAdded(state, payload) {
    ...
    state.orderProductionProductDetailList.forEach((x) => {
      ...
      state.orderProductionProductDetailCostTotal.supplier +=
        x.Miktar * x.AlisFiyati;
      if (x.Iscilik == null) {
        state.orderProductionProductDetailCostTotal.workerman = 0;
      } else {
  ...
  setOrderProductDeleted(state, payload) {
    ...
    const index = state.orderProductionProductDetailList.findIndex(
      (x) => x.ID == payload.ID
    );
  ...
  setOrderProductUpdated(state, payload) {
    const index2 = state.orderProductUpdated.findIndex(
      (x) => x.ID == payload.ID
    );
  ...
  setOrderProductionDetailTotal(state, payload) {
    state.orderProductionDetailTotal =
      parseFloat(payload.DetayTutar_1) +
      parseFloat(payload.DetayTutar_2) +
      parseFloat(payload.DetayTutar_3);
  },
  ...
  setOrderProductionProductDetailCostTotal(state, payload) {
    ...
    state.orderProductionProductDetailCostTotal.brokerage = parseFloat(
      payload.Komisyon
    );
    state.orderProductionProductDetailCostTotal.freight = parseFloat(
      payload.NavlunAlis
    );
    state.orderProductionProductDetailCostTotal.detail =
      parseFloat(payload.DetayAlis_1) +
      parseFloat(payload.DetayAlis_2) +
      parseFloat(payload.DetayAlis_3) +
      parseFloat(payload.EvrakGideri) +
      parseFloat(payload.sigorta_Tutar) +
      parseFloat(payload.DetayTutar_4);
  },
  ...
  setProductionProductWorkermanCalculation(state, payload) {
    if (payload.Tutar == null) {
      ...
      state.orderProductionProductDetailCostTotal.workerman = parseFloat(
        payload.Tutar
      );
    }
  },
