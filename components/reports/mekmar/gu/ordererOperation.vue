<template>
  <div class="container">
    ...
    <div class="row">
      <div class="col">
        <DataTable
          :value="getReportsMekmarGuOrdererThisYear.filter((x) => x.Month <= 6)"
          class="p-datatable-sm"
          :selection="selectedThisYearOrderer"
          selectionMode="single"
          @row-select="thisYearOrdererSelected($event)"
          :loading="loading"
        >
          <template #header>
      ...
      <div class="col">
        <DataTable
          :value="
            getReportsMekmarGuOrdererPreviousYear.filter((x) => x.Month <= 6)
          "
          class="p-datatable-sm"
          :selection="selectedThisYearOrderer"
          selectionMode="single"
          @row-select="previousYearOrdererSelected($event)"
          :loading="loading"
        >
          <template #header>
      ...
      <div class="col">
        <DataTable
          :value="
            getReportsMekmarGuOrdererTwoYearAgo.filter((x) => x.Month <= 6)
          "
          class="p-datatable-sm"
          :selection="selectedThisYearOrderer"
          selectionMode="single"
          @row-select="twoYearAgoOrdererSelected($event)"
          :loading="loading"
        >
          <template #header>
    ...
    <!-- <div class="row">
      <div class="col">
        <DataTable
          :value="
            getReportsMekmarGuOperationThisYear.filter((x) => x.Month <= 6)
          "
          class="p-datatable-sm"
          :selection="selectedThisYearOrderer"
          selectionMode="single"
          @row-select="thisYearAgoOperationSelected($event)"
          :loading="loading"
        >
          >
          <template #header>
      ...
      <div class="col">
        <DataTable
          :value="
            getReportsMekmarGuOperationPreviousYear.filter((x) => x.Month <= 6)
          "
          class="p-datatable-sm"
          :selection="selectedThisYearOrderer"
          selectionMode="single"
          @row-select="previousYearAgoOperationSelected($event)"
          :loading="loading"
        >
          <template #header>
      ...
      <div class="col">
        <DataTable
          :value="
            getReportsMekmarGuOperationTwoYearAgo.filter((x) => x.Month <= 6)
          "
          class="p-datatable-sm"
          :selection="selectedThisYearOrderer"
          selectionMode="single"
          @row-select="twoYearAgoOperationSelected($event)"
          :loading="loading"
        >
          <template #header>
...
export default {
  ...
  methods: {
    excel_output(event) {
      ...
      this.$excelApi
        .post("/gu/reports/seller/operation/orders", data)
        .then((response) => {
          if (response.status) {
      ...
      this.$store
        ...
        .then((res) => {
          if (res) {
            ...
            this.getReportsMekmarGuOrdererThisYear
              .filter((x) => x.Month <= 6)
              .forEach((x) => {
            ...
            this.getReportsMekmarGuOrdererPreviousYear
              .filter((x) => x.Month <= 6)
              .forEach((x) => {
            ...
            this.getReportsMekmarGuOrdererTwoYearAgo
              .filter((x) => x.Month <= 6)
              .forEach((x) => {
