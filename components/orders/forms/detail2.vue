<template>
    <div class="row mt-3" style="padding:0px 50px;">
        <div class="col-10">
            <TabView>
                <TabPanel header="Order">
                    <orderDetailOrderForm2 :model="modelProduct" :products="productsList" :supplier="supplier"
                        :unit="unit" :po="po" :detailProductTotal="detailProductTotal" :status="status"
        ...
        <div class="col-2">
            ...
            <span class="p-float-label mb-4">
                <Calendar v-model="order_date" inputId="order_date" class="w-100"
                    @date-select="orderDateSelected($event)" :disabled="!status" dateFormat="dd/mm/yy"/>
            ...
            <span class="p-float-label mb-4">
                <AutoComplete v-model="selectedFinanceman" inputId="financeman" :suggestions="filteredFinanceman"
                    @complete="searchFinanceman($event)" field="KullaniciAdi"
